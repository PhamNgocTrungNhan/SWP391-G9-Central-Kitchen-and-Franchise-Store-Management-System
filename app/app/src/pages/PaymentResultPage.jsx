      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-5xl items-center">
        <div className="w-full space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
            <SectionCard title="Tóm tắt callback">
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="app-subcard">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#8d7a59]">Số tiền</p>
            ...
            <SectionCard title="Điều hướng tiếp theo">
