...
const routeConfig = [
  ...
  { path: '/payments', element: <PaymentsPage />, roles: [roles.ADMIN, roles.STORE_STAFF] },
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/success" element={<PaymentResultPage variant="success" />} />
        <Route path="/cancel" element={<PaymentResultPage variant="cancel" />} />
        <Route
          element={(
            <RequireAuth>
              <Layout />
