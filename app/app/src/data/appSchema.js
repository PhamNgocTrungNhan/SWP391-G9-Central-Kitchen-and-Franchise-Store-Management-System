...
export const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/payments', key: 'payments', label: 'Thanh toán', icon: 'payments', roles: [roles.ADMIN, roles.STORE_STAFF] },
...
export const pageCatalog = {
  ...
  payments: {
    ...
    endpoints: [
      { method: 'POST', path: '/api/internal-orders/{orderId}/pay' },
      ...
      { method: 'POST', path: '/api/internal-orders/{orderId}/refund', body: 'RefundByPolicyRequest' },
      { method: 'POST', path: '/api/internal-orders/payos-webhook', note: 'backend callback' },
    ],
  },
  productionBatches: {
