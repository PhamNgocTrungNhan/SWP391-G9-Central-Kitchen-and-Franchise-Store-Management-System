              ...
              <div className="flex flex-col gap-1">
                {group.items.map((item) => (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      [
                        'group flex items-center justify-between gap-2 rounded-[1.1rem] border px-2.5 py-2.5 transition duration-150',
                        isActive
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="flex size-8 items-center justify-center rounded-xl bg-white/70 text-[18px] shadow-sm">
