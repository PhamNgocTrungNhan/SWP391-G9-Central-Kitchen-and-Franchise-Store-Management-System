...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-1MKVEDQ\\SQLEXPRESS;Database=Kitchen2026;User Id=sa;Password=12345;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<InternalOrder>(entity =>
        {
            ...
            entity.Property(e => e.OrderCode)
                .HasMaxLength(13)
                .IsUnicode(false)
                .HasComputedColumnSql("('ORD'+CONVERT([varchar](10),[order_id]))", false)
        ...
        modelBuilder.Entity<ProductionBatch>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductionBatches)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__Productio__produ__628FA481");
        });
        ...
        modelBuilder.Entity<ProductionBatchOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.Batch).WithMany(p => p.ProductionBatchOrders)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Productio__batch__6C190EBB");

            entity.HasOne(d => d.Order).WithMany(p => p.ProductionBatchOrders)
                .HasForeignKey(d => d.OrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Productio__order__6D0D32F4");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(d => d.Kitchen).WithMany(p => p.Users)
                .HasForeignKey(d => d.KitchenId)
                .HasConstraintName("FK__Users__kitchen_i__4222D4EF");
